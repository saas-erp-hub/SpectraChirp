...
def analyze_best_combinations(df):
    ...
    best_combinations = df.groupby(['qam_symbol_rate', 'freq_separation'])['ber'].mean().reset_index()
...
def main():
    ...
    print(f"QAM-Symbolrate: {best_result['qam_symbol_rate']}, Frequenztrennung: {best_result['freq_separation']}, Durchschnittliche BER: {best_result['ber']}")
